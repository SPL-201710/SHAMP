...
{
	public static void applyBlackandWhite(String originalImage,String convertedImage) throws Exception
	{
		
        BufferedImage grayScale;
		try
		{
			grayScale = ImageIO.read(new File(originalImage));
	...
	public void applyNegative(String originalImage, String convertedImage) throws Exception
	{
		BufferedImage img;
		try
		{
