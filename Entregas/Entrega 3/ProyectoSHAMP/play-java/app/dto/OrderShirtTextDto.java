...
public class OrderShirtTextDto implements OrderShirtGeneralDto {
	...
	public OrderShirtGeneralDto mapper(StampShirt stampShirt) {
		...
		OrderShirtTextDto.setQuantity(stampShirt.quantity);
		OrderShirtTextDto.setShirt_id(stampShirt.shirt_id.shirt_id);
		OrderShirtTextDto.setShirt_location(stampShirt.stamp_location);
		OrderShirtTextDto.setShirt_sex("");
		OrderShirtTextDto.setShirt_size(stampShirt.stamp_size);
		OrderShirtTextDto.setStamp_id(stampShirt.stamp_id.stamp_id);
		OrderShirtTextDto.setText_color(stampShirt.text_color);
		OrderShirtTextDto.setText_font(stampShirt.text_font);
		OrderShirtTextDto.setText_size(stampShirt.text_size);
		OrderShirtTextDto.setStamp_url(stampShirt.stamp_url);
		OrderShirtTextDto.setText(stampShirt.text);
		return OrderShirtTextDto;
	}
