...
create table stamps (
  ...
  stamp_rating                  double,
  stamp_blackwhite              varchar(255),
  stamp_negative                varchar(255),
  stamp_sephia                  varchar(255),
  stamp_blur                    varchar(255),
  stamp_buyer                   varchar(255),
  name                          varchar(255),
  active                        tinyint(1) default 0,
  creation_date                 datetime(6),
...
create table stamp_ratings (
  ...
  stamp_comments                varchar(255) not null,
  creation_date                 datetime(6) not null,
...
create table users (
  ...
  base_datos                    tinyint(1) default 0,
...
alter table stamp_ratings add constraint fk_stamp_ratings_user_id foreign key (user_id) references users (user_id) on delete restrict on update restrict;
create index ix_stamp_ratings_user_id on stamp_ratings (user_id);
...
alter table stamp_shirt add constraint fk_stamp_shirt_order_id foreign key (order_id) references user_orders (order_id) on delete restrict on update restrict;
create index ix_stamp_shirt_order_id on stamp_shirt (order_id);
...
alter table stamp_ratings drop foreign key fk_stamp_ratings_user_id;
drop index ix_stamp_ratings_user_id on stamp_ratings;
...
alter table stamp_shirt drop foreign key fk_stamp_shirt_order_id;
drop index ix_stamp_shirt_order_id on stamp_shirt;
